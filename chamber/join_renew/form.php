...
<div class="col-md-9">
	...
	<div class="row">
		<div class="col-md-6">
			<form role="form" id='new-member' method="POST">
		  		...
		  		<div class="form-group">
		    		...
		    		<input type="text" class="form-control" id="memberContactEmail" name="memberContactEmail" placeholder="Enter email">
		  		</div> 
		  		<div class="form-group">
		    		<label for="memberContactNum">Phone Number</label>
		    		<input type="text" class="form-control" id="memberContactNum" name="memberContactNum" placeholder="Enter phone number">
		  		</div>
		  		<div class="form-group">
