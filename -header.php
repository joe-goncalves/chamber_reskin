...
<body>
<div id="wrapper">
    <a href="<?=$GLOBALS['local_url']?> "><img id='header-img' src="<?=$GLOBALS['local_url']?>/images/header-img.png"/></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=$GLOBALS['local_url']?>/about_ronkonkoma/orignal_residents.php">Original Residents and Early Settlers</a>
